...
export default function LogInPage() {
  ...
  return (
    <div className="flex min-h-screen">
      <Helmet>
        <title>Sign In | Anime Search</title>
        <meta name="description" content="Sign in to your Anime Search account." />
      </Helmet>

      {/* Left Section - Background Image */}
      <div
        className="hidden lg:flex w-full lg:w-1/2 h-screen"
        ><ImageCarousel images={images} /></div>
